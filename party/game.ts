...
type MessageType =
  ...
  | { type: "level_change"; level: "overworld" | "desert" }
  | { type: "game_start" }
...
export default class GameRoom implements Party.Server {
  ...
  private currentLevel: "overworld" | "desert" = "overworld";
  ...
  private handleLevelChange(data: { level: "overworld" | "desert" }) {
