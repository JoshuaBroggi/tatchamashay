      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-6">
            ...
            <span className="text-sm font-medium text-purple-200">Quick Start Guide</span>
          </div>
        ...
        <div className="mt-16 p-6 bg-slate-800/50 rounded-2xl border border-white/5 text-center">
          <p className="text-gray-400">
            Need help? Check out our <a href="https://github.com/joshuabroggi/tatchamashay" className="text-purple-400 hover:text-purple-300 underline">documentation</a> or join the community.
          </p>
        </div>
      </div>
    </div>
...
const StepCard: React.FC<StepCardProps> = ({ number, title, description, link, linkText, icon, code }) => (
  <div className="bg-slate-800 p-6 md:p-8 rounded-2xl border border-white/5 shadow-lg transition-all hover:bg-slate-750 hover:border-white/10 group">
    <div className="flex items-start gap-6">
      <div className="flex-shrink-0 w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center border border-white/5 group-hover:border-purple-500/30 transition-colors">
        {icon}
      </div>
